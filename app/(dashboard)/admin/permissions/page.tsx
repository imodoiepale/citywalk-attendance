    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          What each role can do. Admin always has full access, everywhere — it can&rsquo;t be edited
          here, so there&rsquo;s no way to lock every admin out by misconfiguring this table.
        </p>
      </div>
